...
{
    Task<Result<PostResponse>> CreatePostAsync(Guid authUserId, string content, Stream? mediaStream, string? mediaFileName);
    ...
    Task<Result<PostResponse>> UpdatePostAsync(Guid authUserId, Guid postId, string content);
